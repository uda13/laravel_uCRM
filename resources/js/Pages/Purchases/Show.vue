            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <form @submit.prevent="sotrePurchase">
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <tr v-for="item in props.items" :key="item.id">
                                    <td class="border-t-2 border-gray-200  py-3"> {{ item.item_id }}</td>
                                    <td class="border-t-2 border-gray-200  py-3">{{ item.item_name }}</td>
                                    <td class="border-t-2 border-gray-200  py-3">{{ item.item_price }}</td>
                                    <td class="border-t-2 border-gray-200  py-3">{{ item.quantity }}</td>
                                    <td class="border-t-2 border-gray-200  py-3"> {{ item.subtotal }}</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
