                        ...
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <tr v-for="item in itemList" :key="item.id">
                                    <td class="border-t-2 border-gray-200  py-3"> {{ item.id }}</td>
                                    <td class="border-t-2 border-gray-200  py-3">{{ item.name }}</td>
                                    <td class="border-t-2 border-gray-200  py-3">{{ item.price }}</td>
                                    <td class="border-t-2 border-gray-200 py-3">
                                        <select name="quantity" v-model="item.quantity">
                                        <option v-for="q in quantity" :value="q">{{ q }}</option>
                                        </select>
                                    </td>
                                    <td class="border-t-2 border-gray-200  py-3"> {{ item.price * item.quantity }}</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
