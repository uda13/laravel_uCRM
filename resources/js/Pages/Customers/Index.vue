                        ...
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tr v-for="customer in customers.data" :key="customer.id">
                                    <td class="border-t-2 border-gray-200  py-3">{{ customer.id }}</td>                 
                                    <td class="border-t-2 border-gray-200  py-3">{{ customer.name }}</td>
                                    <td class="border-t-2 border-gray-200  py-3">{{ customer.kana }}</td>
                                    <td class="border-t-2 border-gray-200 py-3">  {{ customer.tel }}</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
